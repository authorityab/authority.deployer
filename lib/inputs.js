...
var joystick_up = new Gpio(27, 'in', 'falling'); //rising
var joystick_down= new Gpio(17, 'in', 'falling');
var joystick_left = new Gpio(6, 'in', 'falling');
var joystick_right = new Gpio(5, 'in', 'falling');
...
//	});
	...
	joystick_left.read(function(err, value) {
		if (err) {
			throw err;
		}
