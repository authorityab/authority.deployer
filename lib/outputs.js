...
/*		var _step = 0;
	    ...
	    setTimeout(doSuccessColors, 4000);



	    function doSuccessColors(){
	 		console.log("all success colors are beautiful \\o/")	

	        var myDisplayBuffer = new Buffer(32*3);
	        var animationTick = 0.105;
	        var angle = 0;
	        var ledDistance = 0.3;
	        setInterval(function(){
	          ...
	          for (var i=0; i<myDisplayBuffer.length; i+=3){
	            ...
	            myDisplayBuffer[i] = 0;
	            //green
	            myDisplayBuffer[i+1] = 0;
	            //blue
	            myDisplayBuffer[i+2] = 128 + Math.sin(angle + (i/3)*ledDistance) * 128;
	          }
	    ...
	    function doErrorColors(){
	 		console.log("all error colors are beautiful \\o/")	
