...
module.exports = {
  ...
  animationDurationTimeout = null,
  lastWriteTime: Date.now() - rowResetTime - 1, //last time something was written to SPI, manual of WS2801 says 500 is enough, however we need at least 1000
  sendRgbBuf: null, //function for writing to strip, depends on type. required for save WS2801 reset
  isConnected:  false,
