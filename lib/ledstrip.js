...
module.exports = {
  ...
  numLEDs: 32,
  spiFd: null, //filedescriptor for spidevice
  gamma: 2.5,
  gammatable: new Array(256),
  bytePerPixel: 3, //RGB
  rowResetTime: 1000, // number of us CLK has to be pulled low (=no writes) for frame reset

  // manual of WS2801 says 500 is enough, however we need at least 1000
  lastWriteTime: microtime.now() - rowResetTime - 1, //last time something was written to SPI

  //required for save WS2801 reset
  sendRgbBuf: null, //function for writing to strip, depends on  type
  ...
  connect: function() {
    ...
    sendRgbBuf = (stripType == 'WS2801') ? sendRgbBufWS2801 : sendRgbBufLPD8806;
    numLEDs = numLEDs;
  ...
  animate: function(redVal, greenVal, blueVal, animationTick, duration) {
    ...
    var interval = setInterval(function() {
      ...
      sendRgbBufLPD8806(myDisplayBuffer);
      angle += animationTick;
    }, 5);
